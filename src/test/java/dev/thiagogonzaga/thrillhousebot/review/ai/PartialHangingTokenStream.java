...
/** Emits one partial token synchronously and never completes. */
final class PartialHangingTokenStream implements TokenStream {

  private final String partial;
  private Consumer<String> partialHandler;

  PartialHangingTokenStream(String partial) {
