...
/** TokenStream that emits partial output then reports an error when started. */
final class PartialThenErrorTokenStream implements TokenStream {
  ...
  PartialThenErrorTokenStream(String partialText, Throwable error) {
  ...
  public void start() {
    if (partialHandler != null) {
      partialHandler.accept(partialText);
    }
