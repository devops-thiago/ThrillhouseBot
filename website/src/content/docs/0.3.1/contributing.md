...
This project follows the [Contributor Covenant](https://github.com/devops-thiago/ThrillhouseBot/blob/v0.3.1/CODE_OF_CONDUCT.md). By taking
...
Follow the [README Quick Start](/ThrillhouseBot/0.3.1/getting-started) for cloning, credentials, dev mode, and webhook forwarding — it is the single source of truth for setup commands. Contributor-specific extras:
...
See [docs/ARCHITECTURE.md](/ThrillhouseBot/0.3.1/architecture). Package flow:
...
[README provider table](/ThrillhouseBot/0.3.1/providers) lists the ones that are known
to work.

## Reporting security issues

Please **do not** open a public issue — see [SECURITY.md](https://github.com/devops-thiago/ThrillhouseBot/blob/v0.3.1/SECURITY.md).
