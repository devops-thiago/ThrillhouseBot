...
server-side; review history persists in the database. See [SECURITY.md](https://github.com/devops-thiago/ThrillhouseBot/blob/v0.3.1/SECURITY.md)
...
[README](/ThrillhouseBot/0.3.1/providers).
