...
See [Architecture](/ThrillhouseBot/0.3.1/architecture) and
[Configuration](/ThrillhouseBot/0.3.1/configuration) for details available in this release.
