...
![ThrillhouseBot approving a clean pull request](../../../assets/0.6.1/pr-approval.png)
...
![Dashboard Overview with summary cards, live model-output panel, and recent activity](../../../assets/0.6.1/live-streaming.png)
