...
Documentation snapshot for **v0.2.1**.

![ThrillhouseBot approving a clean pull request](../../../assets/0.2.1/pr-approval.png)
...
- **[Getting started](/ThrillhouseBot/0.2.1/getting-started)** — create the GitHub App and run the bot
- **[Commands](/ThrillhouseBot/0.2.1/commands)** — drive the bot from a PR
- **[Configuration](/ThrillhouseBot/0.2.1/configuration)** — environment variables and defaults
- **[AI providers](/ThrillhouseBot/0.2.1/providers)** — OpenAI-compatible endpoints
- **[Architecture](/ThrillhouseBot/0.2.1/architecture)** — how a review flows through the system
- **[How it compares](/ThrillhouseBot/0.2.1/comparison)** — vs other AI code-review tools
- **[Contributing](/ThrillhouseBot/0.2.1/contributing)** — development setup
...
![Dashboard Overview](../../../assets/0.2.1/live-streaming.png)
