...
See [Architecture](/ThrillhouseBot/0.2.0/architecture) and
[Configuration](/ThrillhouseBot/0.2.0/configuration) for details available in this release.
