...
See [Architecture](/ThrillhouseBot/0.3.0/architecture) and
[Configuration](/ThrillhouseBot/0.3.0/configuration) for details available in this release.
