...
Documentation snapshot for **v0.1.0**.

![ThrillhouseBot approving a clean pull request](../../../assets/0.1.0/pr-approval.png)
...
- **[Getting started](/ThrillhouseBot/0.1.0/getting-started)** — create the GitHub App and run the bot
- **[Configuration](/ThrillhouseBot/0.1.0/configuration)** — environment variables and defaults
- **[AI providers](/ThrillhouseBot/0.1.0/providers)** — OpenAI-compatible endpoints
- **[Architecture](/ThrillhouseBot/0.1.0/architecture)** — how a review flows through the system
- **[How it compares](/ThrillhouseBot/0.1.0/comparison)** — vs other AI code-review tools
- **[Contributing](/ThrillhouseBot/0.1.0/contributing)** — development setup
...
![Dashboard Overview](../../../assets/0.1.0/live-streaming.png)
