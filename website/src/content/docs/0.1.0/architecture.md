...
server-side; review history persists in the database. See [SECURITY.md](https://github.com/devops-thiago/ThrillhouseBot/blob/v0.1.0/SECURITY.md)
...
[README](/ThrillhouseBot/0.1.0/providers).
