...
![ThrillhouseBot approving a clean pull request](../../../assets/0.4.0/pr-approval.png)
...
![Dashboard Overview with summary cards, live model-output panel, and recent activity](../../../assets/0.4.0/live-streaming.png)
